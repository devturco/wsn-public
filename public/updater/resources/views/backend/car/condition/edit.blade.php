  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Car Condition') }}</h5>
        ...
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.car_specification.update_condition') }}"
          ...
          <div class="form-group">
            ...
            <p class="text-warning mt-2 mb-0">
              <small>{{ __('The higher the serial number is, the later the conditon will be shown.') }}</small>
            </p>
          </div>
        </form>
      </div>
