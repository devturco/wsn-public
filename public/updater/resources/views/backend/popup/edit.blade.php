                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <p class="text-warning mt-2 mb-0">
                        <small>{{ __('O pop-up aparecerá na tela após esse tempo de atraso.') }}</small>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <p class="mt-2 mb-0 text-warning">
                        {{ __('Se houver vários pop-ups ativos, os pop-ups serão mostrados na tela de acordo com o número de série.') }}<br>
                        {{ __('Quanto maior o número de série, mais tarde o Popup será mostrado.') }}
                      </p>
                    </div>
                  </div>
                </div>
