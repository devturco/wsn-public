...
@section('content')
    ...
    <div class="container">
      <div class="content">
        ...
        <ul class="list-unstyled">
          ...
          <li class="d-inline active opacity-75">{{ __('Car Details') }}</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="listing-single-area pt-100 pb-60">
    <div class="container">
      @php
        ...
        <div class="col-lg-3">
          <aside class="widget-area" data-aos="fade-up">
            ...
            <div class="widget widget-form bg-light mb-30">
                  ...
                  <div class="user-info">
                    <h6 class="mb-1">
                      <a href="{{ route('frontend.vendor.details', ['username' => $car->vendor->username]) }}"
                        title="{{ $car->vendor->username }}">{{ $car->vendor->username }}</a>
                    </h6>
              ...
              @endif
              <form action="{{ route('frontend.car.contact_message') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="product-default product-inline">
                      <figure class="product-img">
                        <a href="{{ route('frontend.car.details', ['slug' => @$car->car_content->slug, 'id' => $car->id]) }}"
                          ...
                          <img class="lazyload" data-src="{{ asset('assets/admin/img/car/' . $car->feature_image) }}"
                            alt="Product">
                        </a>
                      </figure>
                      <div class="product-details">
