        ...
        <div class="alert border-left border-primary text-dark">
          @if ($package_count >= 2 && $next_membership)
            @if ($next_membership->status == 0)
              <strong
                class="text-danger">{{ __('Você solicitou um pacote que precisa de uma ação (aprovação/rejeição) do administrador. Você será notificado por e-mail assim que uma ação for tomada.') }}</strong><br>
            @elseif ($next_membership->status == 1)
              <strong
                class="text-danger">{{ __('Você tem outro pacote para ativar depois que o pacote atual expirar. Você não pode comprar/estender nenhum pacote até que o próximo pacote seja ativado.') }}</strong><br>
            @endif
          @endif
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  <p class="card-category">{{ __('Carros') }}</p>
          ...
          <div class="card card-stats card-secondary card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Suportes') }}</p>
          ...
          <div class="card card-stats card-info card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Pagamentos') }}</p>
