                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label for="">{{ __('Foto de perfil') }}</label>
                      <br>
                      ...
                      <div class="mt-3">
                        <div role="button" class="btn btn-primary btn-sm upload-btn">
                          {{ __('Escolher uma foto') }}
                          <input type="file" class="img-input" name="photo">
                        </div>
                        <p id="editErr_photo" class="mt-1 mb-0 text-danger em"></p>
                        <p class="mt-2 mb-0 text-warning">{{ __('Tamanho 80x80') }}</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                        ...
                        <div class="form-group">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label"
                              for="show_email_addresss">{{ __('Mostrar e-mail no seu perfil?') }}</label>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label"
                              for="show_phone_number">{{ __('Mostrar número no seu perfil?') }}</label>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label"
                              for="show_contact_form">{{ __('Mostrar formulário de contato?') }}</label>
                          </div>
                        </div>
                      </div>
                    </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group">
                                    ...
                                    <input type="text" value="{{ !empty($vendor_info) ? $vendor_info->city : '' }}"
                                      class="form-control" name="{{ $language->code }}_city" placeholder="Sua cidade">
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    ...
                                    <textarea name="{{ $language->code }}_address" class="form-control" placeholder="Endereço da sua loja">{{ !empty($vendor_info) ? $vendor_info->address : '' }}</textarea>
                                    <p id="editErr_{{ $language->code }}_email" class="mt-1 mb-0 text-danger em"></p>
                                  </div>
                                </div>
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label>{{ __('Detalhes sobre sua loja') }}</label>
                                    <textarea name="{{ $language->code }}_details" class="form-control" rows="5" placeholder="Conte um pouco sobre seu negócio...">{{ !empty($vendor_info) ? $vendor_info->details : '' }}</textarea>
