        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <div class="col-lg-12">
                <label for="" class="mb-2"><strong>{{ __('Galeria') }} *</strong></label>
                <div class="row">
                  <div class="col-12">
              ...
              <form id="carForm" action="{{ route('vendor.car_management.update_car', $car->id) }}" method="POST"
                ...
                <div class="form-group">
                  <label for="">{{ __('Imagem de capa') . '*' }}</label>
                  <br>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label>{{ __('Velocidade máx. (KMH)') }} *</label>
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <select name="status" id="" class="form-control">
                        <option {{ $car->status == 1 ? 'selected' : '' }} value="1">{{ __('Ativar') }}</option>
                        <option {{ $car->status == 0 ? 'selected' : '' }} value="0">{{ __('Desativar') }}</option>
                      </select>
                    </div>
                  </div>
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body">
                              ...
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <select name="{{ $language->code }}_car_condition_id" class="form-control">
                                  ...
                                  @foreach ($conditions as $condition)
                                    <option @selected(@$carContent->car_condition_id == $condition->id) value="{{ $condition->id }}">
                              ...
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <select name="{{ $language->code }}_car_model_id"
                                  ...
                                  @foreach ($brand_models as $brand_model)
                                    <option @selected(@$carContent->car_model_id == $brand_model->id) value="{{ $brand_model->id }}">
                              ...
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <select name="{{ $language->code }}_fuel_type_id" class="form-control">
                                  ...
                                  @foreach ($fuel_types as $fuel_type)
                                    <option @selected(@$carContent->fuel_type_id == $fuel_type->id) value="{{ $fuel_type->id }}">
                              ...
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <select name="{{ $language->code }}_transmission_type_id" class="form-control">
                                  ...
                                  @foreach ($transmission_types as $transmission_type)
                                    <option @selected(@$carContent->transmission_type_id == $transmission_type->id) value="{{ $transmission_type->id }}">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                <label>{{ __('Descrição do anúncio') }} *</label>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                <label>{{ __('Palavras-chaves') }} </label>
                                <input class="form-control" name="{{ $language->code }}_meta_keyword"
                                  placeholder="Insira as palavras e aperte ENTER para confirmar" data-role="tagsinput"
                            ...
                            <div class="col-lg-12">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control" name="{{ $language->code }}_meta_description" rows="5"
                                  placeholder="Insira uma descrição completa do veículo e de sua loja. Isso facilita no Google">{{ $carContent ? @$carContent->meta_description : '' }}</textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="row">
                  <div class="col-lg-12" id="variation_pricing">
                    <h4 for="">{{ __('Especificação adicional (opcional)') }}</h4>
