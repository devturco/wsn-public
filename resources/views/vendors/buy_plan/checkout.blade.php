          ...
          <div class="card-body">
            ...
            <div id="stripe-element">
              ...
              <div class="row gateway-details pt-3" id="tab-iyzico" style="display: none;">
                <div class="col-lg-6">
                  <div class="form-group mb-3">
                    <input class="form-control" type="text" name="iyzicoCardNumber" placeholder="Card Number"
                      disabled />
                  </div>
                </div>
                <div class="col-lg-6 mb-3">
                  <div class="form-group">
                    <input class="form-control" type="text" name="iyzicoExpMonth" placeholder="Expire Month"
                      disabled />
                  </div>
                </div>
                <div class="col-lg-6 ">
                  <div class="form-group">
                    <input class="form-control" type="text" name="iyzicoExpYear" placeholder="Expire Year"
                      disabled />
                  </div>
                </div>
                <div class="col-lg-6 ">
                  <div class="form-group">
                    <input class="form-control" type="text" name="iyzicoCardCode" placeholder="Card Code"
                      disabled />
                  </div>
                </div>
                <div class="col-lg-6 ">
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#payment-gateway").on('change', function() {
        ...
        $("#my-checkout-form").submit(function(event) {
