...
@section('content')
  <div class="mt-2 mb-4">
    <h2 class="pb-2">{{ __('Bom te ver aqui,') }} {{ $authAdmin->first_name . ' ' . $authAdmin->last_name . '!' }}</h2>
  </div>
  ...
  <div class="row dashboard-items">
          ...
          <div class="card card-stats card-success card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Veículos') }}</p>
          ...
          <div class="card card-stats card-primary card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Produtos') }}</p>
          ...
          <div class="card card-stats card-warning card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Pedidos') }}</p>
          ...
          <div class="card card-stats card-info card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Artigos') }}</p>
          ...
          <div class="card card-stats card-secondary card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Lojistas') }}</p>
                    <h4 class="card-title">
                      {{ $vendors }}
                    </h4>
                  </div>
          ...
          <div class="card card-stats card-orchid card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Usuários') }}</p>
          ...
          <div class="card card-stats card-dark card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Assinantes') }}</p>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <div class="card-title">{{ __('Compra de Pacote Mensal') }} ({{ date('Y') }})</div>
        </div>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <div class="card-title">{{ __('Usuários registrados por mês') }} ({{ date('Y') }})</div>
        </div>
